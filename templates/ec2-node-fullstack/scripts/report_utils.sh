...
run_npm_audit() {
  ...
  # Combine totals
  NPM_CRITICAL=$((SERVER_CRITICAL + CLIENT_CRITICAL))
  NPM_HIGH=$((SERVER_HIGH + CLIENT_HIGH))
  NPM_MODERATE=$((SERVER_MODERATE + CLIENT_MODERATE))
...
run_snyk_scan() {
  ...
  if [ -n "$SNYK_TOKEN" ]; then
    ...
    # Combine totals
    SNYK_CRITICAL=$((SERVER_SNYK_CRITICAL + CLIENT_SNYK_CRITICAL))
    SNYK_HIGH=$((SERVER_SNYK_HIGH + CLIENT_SNYK_HIGH))
